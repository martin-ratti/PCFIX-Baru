            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div className="mt-6 flex justify-end">
                        <button type="submit" disabled={isLoading} className="text-sm bg-gray-100 text-gray-700 px-4 py-2 rounded-lg font-bold hover:bg-gray-200 transition-all active:scale-95">
                ...
                <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <div className="md:col-span-2 bg-yellow-50 p-5 rounded-xl border border-yellow-200">
                            ...
                            <div className="flex gap-3 flex-wrap">
                                ...
                                <button
                                    ...
                                    disabled={isSyncing}
                                    className="bg-black text-yellow-400 px-5 py-3 rounded-lg font-bold text-sm hover:bg-gray-900 transition-all active:scale-95 shadow-sm flex items-center gap-2 disabled:opacity-70 whitespace-nowrap"
                    ...
                    <div className="mt-6 flex justify-end">
                        <button type="submit" disabled={isLoading} className="text-sm bg-yellow-100 text-yellow-800 px-4 py-2 rounded-lg font-bold hover:bg-yellow-200 transition-all active:scale-95">
                ...
                <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div className="mt-6 flex justify-end">
                        <button type="submit" disabled={isLoading} className="text-sm bg-green-100 text-green-800 px-4 py-2 rounded-lg font-bold hover:bg-green-200 transition-all active:scale-95">
                ...
                <div className="sticky bottom-4 z-10 flex justify-center">
                    <button disabled={isLoading} className="bg-gray-900 text-white px-8 py-3 rounded-full font-bold hover:bg-black transition-all active:scale-95 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 disabled:opacity-50 disabled:transform-none flex items-center gap-2">
