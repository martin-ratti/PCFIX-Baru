      ...
      <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input {...register('nombre')} className="w-full mt-1 p-2 border rounded-md" placeholder="Ej: Ryzen 5 5600X" />
        ...
        <div className="md:col-span-2">
          ...
          <textarea {...register('descripcion')} rows={4} className="w-full mt-1 p-2 border rounded-md" placeholder="Detalles técnicos del producto..."></textarea>
        </div>
