...
export default function AdminLinks() {
  ...
  const navLinkClass = "text-sm font-bold text-gray-500 hover:text-black transition-colors px-3 py-1.5 rounded-lg hover:bg-gray-100";
  const toolBtnClass = "flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-bold text-gray-600 bg-gray-100 hover:bg-gray-200 hover:text-black transition-all border border-gray-200 cursor-pointer";
  ...
  return (
    <div className="flex items-center gap-4 border-l border-gray-300 pl-4 ml-2">
      ...
      <div className="flex items-center gap-2 ml-2">
        ...
        {/* 👇 AQUÍ DEFINIMOS EL DISEÑO DEL BOTÓN TARIFAS */}
        <ServicePriceModal>
