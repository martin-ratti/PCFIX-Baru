...
export default function AdminLinks() {
  ...
  const linkClass = "flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-gray-600 hover:text-primary hover:bg-gray-100 transition-all whitespace-nowrap";
  // Estilo para el activo (opcional, por ahora genérico)

  return (
    <div className="flex items-center justify-between w-full">
      
      {/* GRUPO NAVEGACIÓN */}
      {/* Quitamos scrollbar agresivo y damos espacio */}
      <nav className="flex items-center gap-1 p-1 rounded-lg bg-transparent">
      ...
      <div className="ml-auto pl-4">
        <a 
            href="/admin/nuevo" 
            className="flex items-center gap-2 bg-primary text-white px-5 py-2.5 rounded-full text-sm font-bold hover:bg-opacity-90 shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5 whitespace-nowrap"
        >
