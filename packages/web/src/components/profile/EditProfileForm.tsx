...
type ProfileData = z.infer<typeof profileUpdateSchema> & { email: string };
  ...
  const onSubmit = async (data: ProfileData) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Actualizar localmente el store de Zustand
        if (authStore.user) {
    ...
    <div className="bg-white p-8 rounded-lg shadow-xl max-w-2xl mx-auto border border-gray-100">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          ...
          {/* El email se muestra pero se deshabilita para evitar lógica compleja de cambio */}
