...
export default function ProductCard({ product, disableTransition = false }: ProductCardComponentProps) {
  ...
  const isService = product.categoria?.nombre.toLowerCase().includes('servicio');
          ...
          <div className="mt-auto pt-2">
            ...
            {isClient && (
              isAdmin ? (
                ...
                isService ? (
                  <a href="/tienda/servicios" className="w-full bg-black text-white font-bold py-2.5 px-4 rounded-lg text-center text-sm flex items-center justify-center gap-2 hover:bg-gray-800 transition-colors">
                  ...
                  !itemInCart ? (
                    hasStock ? (
                      <button
                        ...
                        className="w-full font-bold py-2.5 px-4 rounded-lg transition-all shadow-md hover:shadow-lg bg-primary text-white hover:bg-primary/90 active:scale-95 focus-ring flex items-center justify-center gap-2"
                      ...
                      <button
                        ...
                        className="w-full font-bold py-2.5 px-4 rounded-lg transition-all shadow-sm border border-primary text-primary hover:bg-primary hover:text-white flex items-center justify-center gap-2 group/btn active:scale-95 focus-ring"
                      >
